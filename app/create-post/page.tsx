...
import { ArrowLeft, X, ImageIcon, Smile, AtSign, MapPin, Users, Globe } from "lucide-react"

export default function CreatePostPage() {
  const router = useRouter()
  const [postText, setPostText] = useState("")
  const [selectedImage, setSelectedImage] = useState<string | null>(null)
  const [audience, setAudience] = useState("everyone") // everyone, connections, private
  ...
  const handlePost = () => {
    ...
    // Redirect back to explore after posting
    router.push("/explore")
  }
  ...
  const audienceOptions = [
    ...
    { value: "private", label: "Only me", icon: Users }
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="sticky top-0 bg-white border-b border-slate-200 z-10">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-xl font-heading text-primary-navy">Create Post</h1>
          </div>
          <Button
            onClick={handlePost}
      ...
      <div className="p-4 max-w-2xl mx-auto">
        ...
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            <p className="font-heading text-primary-navy">Your Name</p>
        ...
        <div className="space-y-4 mb-8">
          <div className="flex items-center justify-between p-4 border border-slate-200 rounded-xl hover:bg-slate-50 cursor-pointer">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm font-medium text-slate-700">Tag people</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between p-4 border border-slate-200 rounded-xl hover:bg-slate-50 cursor-pointer">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm font-medium text-slate-700">Share with specific people</span>
            </div>
          </div>
        </div>
