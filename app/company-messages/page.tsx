...
import { Search, MoreHorizontal, Circle, Star, Archive, Trash2, Send, ArrowLeft, Phone, Video, Info, MessageCircle } from "lucide-react"
  ...
  const StarredModal = () => (
    <Dialog open={showStarredModal} onOpenChange={setShowStarredModal}>
      <DialogContent className="max-w-[95%] sm:max-w-4xl max-h-[85vh] sm:max-h-[80vh] overflow-y-auto mx-3 sm:mx-auto">
        <DialogHeader>
          <DialogTitle className="text-lg sm:text-2xl font-heading text-primary-navy flex items-center">
            <Star className="h-5 w-5 sm:h-6 sm:w-6 mr-2 fill-amber-400 text-amber-400" />
          ...
          <div className="flex items-center justify-between mb-6 sm:mb-8">
            ...
            <div className="flex items-center">
              <Button 
                variant="ghost" 
                size="icon" 
                className="rounded-xl h-10 w-10 sm:h-12 sm:w-12 text-primary-navy hover:bg-primary-navy/10"
              >
